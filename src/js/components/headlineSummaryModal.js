        ...
        <div class="bg-white/80 backdrop-blur-lg shadow-2xl rounded-t-2xl overflow-hidden">
          ...
          <div class="overflow-y-auto max-h-[calc(90vh-4rem)] p-4">
            ...
            <div class="flex gap-2 mb-4 overflow-x-auto">
              <a id="sourceBtn" href="#" target="_blank" rel="noopener noreferrer" class="px-3 py-2 border-2 border-slate-300 text-slate-700 rounded-lg hover:bg-slate-50 transition text-tiny font-medium flex items-center gap-1 whitespace-nowrap flex-shrink-0">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                </svg>
                <span id="sourceName"></span>
              </a>
              <a id="readFullStoryBtn" href="#" target="_blank" rel="noopener noreferrer nofollow" class="px-3 py-2 border-2 border-rose-600 text-rose-600 rounded-lg hover:bg-rose-50 transition text-tiny font-medium flex items-center gap-1 whitespace-nowrap flex-shrink-0">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
                Read Article
              </a>
              <button id="viewOnMapBtn" class="px-3 py-2 border-2 border-rose-600 text-rose-600 rounded-lg hover:bg-rose-50 transition text-tiny font-medium flex items-center gap-1 whitespace-nowrap flex-shrink-0">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
