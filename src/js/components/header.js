        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex md:hidden items-center gap-2 ml-auto">
            <button id="subscribeToggleMobile"
                    class="px-3 py-1.5 rounded-lg border-2 border-rose-600 text-rose-600 hover:bg-rose-50 transition text-small font-medium"
          ...
          <nav id="mainNav" class="hidden md:flex items-center gap-6" role="navigation" aria-label="Primary">
            ...
            <button id="subscribeToggle"
                    class="px-4 py-1.5 rounded-lg border-2 border-rose-600 text-rose-600 hover:bg-rose-50 transition text-nav font-medium"
                    aria-label="Subscribe to our channels">
              Subscribe
            </button>
          </nav>
