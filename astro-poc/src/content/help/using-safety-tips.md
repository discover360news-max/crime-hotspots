...
Go to [Safety Tips](/trinidad/safety-tips/) to browse all tips. You can filter by category or context using the chips at the top of the page. Tips tagged to your area will surface if you navigate to an area profile page — the area profile includes a section showing tips most relevant to that location's crime profile.
...
Yes — each tip has a voting system. Tips with higher positive votes surface higher in listings. If you find a tip unhelpful or outdated, you can vote it down.

See also: [Submitting a Safety Tip](/help/submitting-a-safety-tip/).
