/**
 * Production → LIVE Sync Helper for Guyana
 *
...
const LIVE_SHEET_ID = '1vrcFOQ4uLrjhSnZBc6wRSdajLbXC2g5u5F0zRW1vUjc'; // Replace with your LIVE Google Sheet ID
const LIVE_SHEET_NAME = 'Form Responses 2';      // Name of the tab in LIVE sheet
...
function syncProductionToLive() {
  Logger.log('=== SYNCING PRODUCTION → LIVE (GUYANA) ===\n');
