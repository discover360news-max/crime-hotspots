/**
 * Configuration file for Crime Hotspots Automated Pipeline - GUYANA ONLY
...
// ============================================================================
// NEWS SOURCES - GUYANA ONLY
// ============================================================================

/**
 * RSS feed configuration for Guyana news sources
 * This is the ONLY place where feeds should be defined
 * rssCollector references this configuration
 */
const NEWS_SOURCES = [
  {
    name: "Demerara Waves",
...
function logConfigStatus() {
  Logger.log('=== GUYANA CONFIGURATION STATUS ===');
  Logger.log(`Country: Guyana (GY)`);
  ...
  NEWS_SOURCES.filter(s => s.enabled).forEach(source => {
