...
// Sends crime reports via email (no Google Sheets needed)
  ...
  data.countryName}`;
    ...
    const htmlBody = `
      <html>
        <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 
  auto;">
          <h2 style="color: #e11d48;">New Crime Report Submitted</h2>

          <table style="width: 100%; border-collapse: collapse;">
            <tr style="background-color: #f8f9fa;">
              <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: 
  bold;">Report ID</td>
              <td style="padding: 10px; border: 1px solid #dee2e6;">${data.id}</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: 
  bold;">Date of Incident</td>
  ...
  #dee2e6;">${data.countryName}</td>
            ...
            <tr style="background-color: #f8f9fa;">
              <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: 
  bold;">Area</td>
              <td style="padding: 10px; border: 1px solid #dee2e6;">${data.area || 
  'Not specified'}</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: 
  bold;">Street/Location</td>
              <td style="padding: 10px; border: 1px solid #dee2e6;">${data.street || 
  'Not specified'}</td>
            </tr>
            <tr style="background-color: #f8f9fa;">
              <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: 
  ...
  // === CREATE RESPONSE ===
  // CORS is handled automatically by Apps Script when deployed with "Who has access: Anyone"
